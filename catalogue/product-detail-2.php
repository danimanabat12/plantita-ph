...
<head>
    ...
    <title>Snake Plant | Plantita.ph</title>
            ...
            <section class="landing-page">
                <div class="main-landing">
                    <div class="product-img">
                        ...
                        <img src="img/image2.png" alt="sansevieria">
                    </div>
                    <div class="hero-headlines">
                        <h1>Snake Plant</h1>
                        <p>Sansevieria trifasciata (also known as snake plant or mother-in-law's tongue) is one of the most popular and hardy species of houseplants. It features stiff leaves that range from 6 inches to 8 feet tall, depending on the variety.</p>
                        <p id="price">Php 400.00</p>
